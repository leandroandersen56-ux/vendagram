...
const FAQS = [
  ...
  { q: "Como solicitar reembolso?", a: "Caso a disputa seja resolvida a seu favor, o reembolso é creditado automaticamente na sua carteira Froiv by Top Login. De lá você pode sacar via Pix." },
  { q: "Como me tornar vendedor?", a: "Basta criar um anúncio pela Central do Vendedor. Todos os usuários podem vender na plataforma." },
  { q: "Qual a taxa da Froiv by Top Login?", a: "A Froiv by Top Login cobra uma taxa fixa de 10% sobre cada venda. Não há mensalidade ou taxa de cadastro." },
  ...
  { q: "A Froiv by Top Login é segura?", a: "Sim! Todo pagamento é protegido pelo Escrow. O vendedor só recebe após o comprador verificar a conta. Além disso, usamos criptografia para proteger credenciais." },
