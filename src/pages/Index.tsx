...
const BANNERS = [
  { img: bannerHero1, title: "Contas de Instagram", subtitle: "Perfis verificados, engajados\ne prontos para monetizar", cta: "Ver contas", link: "/marketplace", objectPosition: "right 40%" },
            ...
            <div className="relative">
              <div className="flex gap-3 overflow-x-auto scrollbar-hide pb-2 -mx-1 px-1 snap-x snap-mandatory fade-edges" id="destaques-scroll">
                {(loading ? Array(8).fill(null) : filtered.slice(0, 10)).map((listing, i) =>
                  listing ? (
                    <div key={listing.id} className="flex-shrink-0 w-[calc((100vw-2rem-24px)/3)] sm:w-[180px] md:w-[200px] snap-start h-[280px] sm:h-[300px] md:h-[320px]">
                      <ListingCard listing={listing} />
                    </div>
                  ) : (
                    <div key={i} className="flex-shrink-0 w-[calc((100vw-2rem-24px)/3)] sm:w-[180px] md:w-[200px] h-[280px] sm:h-[300px] md:h-[320px]">
                      <SkeletonCard />
                    </div>
                  )
                )}
