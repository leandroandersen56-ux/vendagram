          ...
          >
            <div className="p-4 bg-[#F8FAFF]">
              ...
              <div className="space-y-1 text-[13px] mb-3">
                ...
                <div className="flex justify-between"><span className="text-[#888]">Taxa Froiv (10%)</span><span className="text-[#111]">-{formatBRL(offer.offered_price * 0.10)}</span></div>
                <div className="h-px bg-[#E8E8E8] my-1" />
                <div className="flex justify-between"><span className="text-[#888] font-semibold">Você receberá</span><span className="text-[#00A650] font-bold">{formatBRL(offer.offered_price * 0.90)}</span></div>
              </div>
