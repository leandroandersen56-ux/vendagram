  ...
  return (
    <div className="rounded-xl border border-[hsl(var(--border))] bg-white overflow-hidden">
      <button
        ...
        aria-expanded={open}
      >
        <span className="text-sm font-semibold text-[hsl(var(--txt-primary))] flex items-center gap-1.5"><BarChart3 className="h-4 w-4 text-primary" /> Detalhes da conta</span>
