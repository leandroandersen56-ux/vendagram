  ...
  return (
    <>
      <div className="space-y-0">
        ...
        <div
          className="relative overflow-hidden bg-white group cursor-zoom-in pt-2 px-2 pb-0 lg:rounded-xl lg:ring-1 lg:ring-border/40 lg:shadow-[0_2px_8px_rgba(0,0,0,0.14)]"
