...
import logoFroivWhite from "@/assets/logo-froiv-header.png";
import {
...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed left-0 right-0 z-50 bg-primary" style={{ height: '56px', top: 'var(--pwa-banner-offset, 0px)' }}>
